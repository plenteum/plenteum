...
namespace WalletConfig
{
    ...
    const std::string daemonName = "Plenteumd";

    /* The name to call this wallet */
    const std::string walletName = "zedwallet";

    /* The name of wallet-service, the programmatic rpc interface to a wallet */
    ...
    const std::string contactLink = "https://discord.gg/EdE5jcC";


    /* The number of decimals your coin has - the number less than the display decimal places is what is used for the dust fund */
    const int numDecimalPlaces = CryptoNote::parameters
                                           ::CRYPTONOTE_DUST_DECIMAL_POINT;

                                            /* The number of decimals your coin should display */
    ...
    const uint64_t minimumSend = CryptoNote::parameters::MINIMUM_FEE * 10;
    ...
    const uint64_t mixinZeroDisabledHeight
        = CryptoNote::parameters::MIXIN_LIMITS_HEIGHT;
}
